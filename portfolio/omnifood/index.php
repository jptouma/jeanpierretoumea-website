...
<html lang="en">
	...
	<head>
		...
		<meta name="Description" content="Omnifood is a premium food delivery service with the misson to bring affordable and healthy meals to as many people as possible.">
		<meta name="keywords" content="Omnifood, Food, Meals, Super Healthy, Healthy, Food Delivery, Fast Food, Organic, Pizza">
		...
		<link rel="icon" type="image/png" sizes="180x180" href="./resources/favicons/apple-touch-icon.png">
	...
	<body>
		...
		<header>
			...
			<div class="hero-text-box">
				...
				<a class="btn btn-full js-scroll-to-signup" href="#">I'm hungry</a>
				<a class="btn btn-ghost js-scroll-to-features" href="#">Show me more</a>
			</div>
		</header>
		<!-- FEATURES -->
		<section class="section-features js-section-features" id="food-delivery">
			<div class="row">
				<h2>Get food fast &mdash; not fast food</h2>
				<p class="long-copy">Hello, we’re Omnifood, your new premium food delivery service. We know you’re always busy. 
				No time for cooking. So let us take care of that, we’re really good at it, we promise!</p>
			</div>
		...
		<!-- FAVORITE MEALS -->
		<section class="section-fav-meals">
			<ul class="fav-meals-showcase clearfix">
				<li>
		...
		<section class="section-steps" id="how-it-works">
			...
			<div class="row">
				<div class="col span-1-of-2 steps-box">
					<img class="app-screen js-wp-2" src="resources/img/app-iPhone.png" alt="Omnifood Mobile App">
				</div>
				<div class="col span-1-of-2 steps-box">
					...
					<a class="btn-app app-store" href="#"><img src="resources/img/download-app.svg" alt="App Store Button"></a>
		...
		<section class="section-cities" id="our-cities">
			...
			<div class="row js-wp-3">
				<div class="col span-1-of-4 box">
					<img class="city-image" src="resources/img/lisbon-3.jpg" alt="Lisbon">
					<h3>Lisbon</h3>
				...
				<div class="col span-1-of-4 box">
					<img class="city-image" src="resources/img/san-francisco.jpg" alt="San Francisco">
					<h3>San Francisco</h3>
					<div class="city-feature">
						<i class="ion-ios-person icon-small"></i>
						3700+ happy eaters
				...
				<div class="col span-1-of-4 box">
					<img class="city-image" src="resources/img/berlin.jpg" alt="Berlin">
					<h3>Berlin</h3>
					<div class="city-feature">
						<i class="ion-ios-person icon-small"></i>
						2300+ happy eaters
				...
				<div class="col span-1-of-4 box">
					<img class="city-image" src="resources/img/london.jpg" alt="London">
					<h3>London</h3>
					<div class="city-feature">
						<i class="ion-ios-person icon-small"></i>
						1200+ happy eaters
			...
			<div class="row">
				...
				<div class="col span-1-of-3">
					<blockquote>
						...
						We have lots of food delivery here in Lisbon, but no one comes even close to Omnifood. Me and my family are so in love!
		...
		<section class="section-signup js-section-signup" id="sign-up">
			<div class="row">
					...
					<div class="row">
						<form class="contact-form" method="post" action="mailer.php">
							...
							<div class="row">
								...
								<div class="col span-2-of-3">
									<input id="e-mail" name="email" type="email" placeholder="Type your e-mail" required>
								</div>
							</div>
							<div class="row">
								<div class="col span-1-of-3">
							...
							<div class="row">
								...
								<div class="col span-2-of-3">
									<input id="newsletter" name="newsletter" type="checkbox"> Yes, please!
								</div>
							</div>
							<div class="row">
								<div class="col span-1-of-3">
		...
		<footer class="section-footer">
			...
			<div class="row">
				...
				<p>Built with <i class="ion-heart"></i> in the beautiful city of Stockholm, Sweden, May 2018.</p>
			</div>
		</footer>
